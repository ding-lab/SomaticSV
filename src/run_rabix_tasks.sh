...
-l LOGD: directory where runtime output (CASE.out and CASE.err) written.  Default "./logs"
-h: print usage information
-d: dry run: print commands but do not run
-1 : stop after one case processed.
-J N: run N tasks in parallel.  Default 1

RABIXD is created by rabix.  LOGD is STDERR and STDOUT of rabix
...
function get_rabix_cmd {
    ...
    CMD="rabix --basedir $OUTD $CWL $YAML > $STDOUT 2> $STDERR"
